...
\end{equation*}
donde D es el diámetro de la espira, 0,3 m. Tomando $\mu_0=4\pi \cdot 10^{-7}$, resulta que
...
espira, de $B_{imanes} = 27,4 \, T$. Así, por principio de superposición, el campo magnético se puede estimar
como $B = B_{autoinducido}+B_{imanes}=27,4 T$.
...
\begin{align*}
    \tau_{arranque} &= 60 \cdot 0,5 A \cdot 7,07 \cdot 10^{4} \, m^2 \cdot 27,4 T \\
                    &= 0,58 \, Nm
\end{align*}
